  ...
  const EVENTS = {
    technical: [
      ...
      { id: 'Design To Dev', name: 'DESIGN TO DEV', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
      { id: 'Wired-WOnders', name: 'WIRED WONDERS', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
      { id: 'Robot Craze', name: 'ROBOT CRAZE' , closed: true, 
        closedReason: 'Registration closed on April 13, 2025' },
      { id: 'Byte the dice', name: 'BYTE THE DICE', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' }, 
      { id: 'Decodex', name: 'DECODEX', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
    ],
    nonTechnical: [
      { id: 'Anime ', name: 'SENPAI FANS', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
      { id: 'Aural Bliss', name: 'AURAL BLISS', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
      { id: 'TreasureHunt', name: 'TREASURE HUNT', closed: true, 
        closedReason: 'Registration closed on April 14, 2025' },
      { id: 'SportsBz', name: 'SPORTS BUZZ', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
      { id: 'OjingeoGame', name: 'OJINGEO GAME', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
    ...
    onlineevents: [
      { id: 'shortfilm ', name: 'SHORT FILM', closed: true, 
        closedReason: 'Registration closed on April 15, 2025' },
      { 
        id: 'esports ', 
